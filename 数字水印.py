...
dragon = cv2.imread(path_2,0)

Pd = Pd[600:900,250:650]
dragon = dragon[200:500,100:500]
w,h = Pd.shape
# print(Pd.shape)
# print(dragon.shape)
#提取水印图片的最高位
a = np.ones((w,h),dtype=np.uint8)*128#1000 0000
ShuiY = cv2.bitwise_and(dragon,a)
